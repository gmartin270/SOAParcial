package org.guille.parcialsoa.exception;

import java.text.ParseException;

import org.apache.log4j.Logger;
import org.guille.parcialsoa.dto.ResponseStatus;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> badRequest(Exception exception) {
		log.error("Error", exception);
		return new ResponseEntity(new ResponseStatus("02000","Opsss! Error General: " + exception.getMessage()), HttpStatus.BAD_REQUEST);
	}
}
